...
public class GUI extends JFrame {
    ...
    public static class DatabaseConnection {
        private static String dbProto = System.getenv("DVDSRENTAL_DB_PROTO");  
        private static String dbHost = System.getenv("DVDSRENTAL_DB_HOST");    
        private static String dbPort = System.getenv("DVDSRENTAL_DB_PORT");   
        private static String dbName = System.getenv("DVDSRENTAL_DB_NAME");     
        private static String dbUsername = System.getenv("DVDSRENTAL_DB_USERNAME");
        private static String dbPassword = System.getenv("DVDSRENTAL_DB_PASSWORD"); 

        // Construct the database URL from the environment variables
        private static String dbUrl = dbProto + "://" + dbHost + ":" + dbPort + "/" + dbName;
        ...
        public static Connection getConnection() throws SQLException {
            ...
            // Return the connection using the static variables
